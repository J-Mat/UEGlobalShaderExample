...
class FCustomComputeShader : public FGlobalShader
{
	...
	SHADER_USE_PARAMETER_STRUCT(FCustomComputeShader, FGlobalShader)
		...
		SHADER_PARAMETER_RDG_BUFFER_SRV(StructuredBuffer<FVector3f>, Vertices)

		SHADER_PARAMETER_RDG_TEXTURE_UAV(RWTexture2D<FVector4f>, OutputTexture)
	...
	void BuildAndExecuteGraph(FRHICommandListImmediate& RHICmdList, UTextureRenderTarget2D* RenderTarget, TArray<FVector3f> InVerts);
};